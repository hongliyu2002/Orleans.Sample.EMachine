...
[Immutable]
[GenerateSerializer]
public sealed record SnackMachineRepositoryGetListQuery : SnackMachineRepositoryQuery
{
    public SnackMachineRepositoryGetListQuery(int maxResultCount, int skipCount, Guid traceId, string operatedBy)

...
public class SnackMachineGrainTests : IClassFixture<SnackMachineFixture>
{
    ...
    public async Task Can_Initialize_And_Get_SnackMachine()
    {
        ...
        var slots = ImmutableList.Create(new Slot(id, 0), new Slot(id, 1, new SnackPile(cafeSnackId, 10, 5)), new Slot(id, 2), new Slot(id, 3, new SnackPile(chocolateSnackId, 20, 8)));
    ...
    public async Task Can_Remove_SnackMachine()
    {
        ...
        var slots = ImmutableList.Create(new Slot(id, 0), new Slot(id, 1, new SnackPile(sodaSnackId, 10, 5)), new Slot(id, 2));

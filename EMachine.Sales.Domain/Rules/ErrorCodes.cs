...
public sealed class ErrorCodes : Enumeration<ErrorCodes, int>
{
    ...
    public static readonly ErrorCodes SnackMachineNotEnoughMoney = new(209, nameof(SnackMachineNotEnoughMoney));
    public static readonly ErrorCodes SnackMachineNotEnoughChange = new(210, nameof(SnackMachineNotEnoughChange));
